...
from src.meta_network.network import MetaNetwork
...
class Simulation:
    def __init__(self, **cfg):
        ...
        self._env = MetaNetwork(sim=self)
    ...
    def move_environment(self, **cfg):
        ...
        self.greedy_counter = 0
        self.non_greedy_counter = 0
        print(self._cost_weights)
        self._env.move_environment(**cfg)
    def reset(self):
        self.NET_TIMESLOT_STEP = 0
