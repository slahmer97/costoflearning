...
plt.xticks([0, 500, 1000, 1500, 2000], ['0', '500', '1000', '1500', '2000'], rotation=20)

# Plot the EMA of the performance metric
plt.plot(combined_data['performance_ema'], label='Reward', color='forestgreen')
plt.ylabel('Normalized Performance')
plt.grid(True)
plt.title('Normalized Performance Over Time Across The 5 First Environments')
...
# Save as a TeX file
import tikzplotlib
tikzplotlib.save("tex-fig-output/normalized-perf.tex")
